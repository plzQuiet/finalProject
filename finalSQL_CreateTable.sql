...
CREATE TABLE "MEMBER" (
	...
	"AUTHORITY"	        NUMBER	 CHECK(AUTHORITY IN (1, 2)) NOT NULL
);
...
CREATE TABLE "CLASS_PEOPLE" (
   ...
   "APPROVE_TYPE"   CHAR(1)  DEFAULT 'N' CHECK(APPROVE_TYPE IN ('Y', 'N')) NOT NULL,
...
COMMENT ON COLUMN "CLASS_PEOPLE"."APPROVE_TYPE" IS '승인여부(거부 :  N, 승인 : Y)';
...
CREATE TABLE "BOOK_REQUEST" (
   ...
   "BOOK_ AUTHOR"   VARCHAR2(500)      NOT NULL,
   "BOOK_TITLE"   VARCHAR2(1000)      NOT NULL,
   "BOOK_PUB"   VARCHAR2(500)      NOT NULL,
   "REQ_ST"   CHAR(1)   DEFAULT 'I'  CHECK(REQ_ST IN ('I', 'C')) NOT NULL,
...
COMMENT ON COLUMN "BOOK_REQUEST"."BOOK_ AUTHOR" IS '저자';
COMMENT ON COLUMN "BOOK_REQUEST"."BOOK_TITLE" IS '도서명';
COMMENT ON COLUMN "BOOK_REQUEST"."BOOK_PUB" IS '출판사';
COMMENT ON COLUMN "BOOK_REQUEST"."REQ_ST" IS '신청중(I), 신청완료(C),';
...
CREATE TABLE "BOOK" (
   ...
   "BOOK_TITLE"   VARCHAR2(1000)      NOT NULL,
   "BOOK_PUB"   VARCHAR2(500)      NOT NULL,
   "BOOK_PUB_DT"   DATE   DEFAULT SYSDATE   NOT NULL,
...
COMMENT ON COLUMN "BOOK"."BOOK_ AUTHOR" IS '저자';
