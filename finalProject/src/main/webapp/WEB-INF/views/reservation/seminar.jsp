...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/reservation/study.css">
    ...
    <section class="main-content-suround-section">
        <article class="side-menu-article">
            ...
            <ul class="side-menu">
                ...
                <li class="side2 side-current" class="current"><a href="#">세미나실</a></li>
            </ul>
        ...
        <section class="content-suround-section">
            ...
            <div class="reservation-container">
                ...
                <button class="seminar"><a href="">세미나실 예약</a></button>
            </div>
            <br>
