		...
		<section class="list-area">
			...
			<c:if test="${fn:length(list) > 0}">
				<div class="pagination-area">
		            <ul class="pagination">
		                <li><a href="/myLibrary/reserv?m=2&cp=1">&lt;&lt;</a></li>
		                <li><a href="/myLibrary/reserv?m=2&cp=${pagination.prevPage}">&lt;</a></li>
		                <c:forEach var="i" begin="${pagination.startPage}" end="${pagination.endPage}">
		                    <c:choose>
		                        ...
		                        <c:otherwise>
		                            <li><a href="/myLibrary/reserv?m=2&cp=${i}">${i}</a></li>
		                        </c:otherwise>
		                    </c:choose>
		                </c:forEach>
		                <li><a href="/myLibrary/reserv?m=2&cp=${pagination.nextPage}">&gt;</a></li>
		                <li><a href="/myLibrary/reserv?m=2&cp=${pagination.maxPage}">&gt;&gt;</a></li>
		            </ul>
		        </div>
	        </c:if>
		</section>
