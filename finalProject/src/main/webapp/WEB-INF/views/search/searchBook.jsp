					...
					<div class= "searchBody">
						...
						<div class="bookDetail">
							...
							<div class="bookDetailState"> 
								...
								<div class="informBtn"><button id="informBtn">예약 / 소장 정보<img src=""/></button></div>
							</div>
						</div>
						<!-- 즐겨찾기 -->
						<div class="favorite">
							<div><button class="favoriteStar"></button></div>
						</div>
					</div>
					<hr>
					...
					<div class= "searchBody">
						...
						<div class="bookDetail">
							...
							<div class="bookDetailState"> 
								...
								<div class="informBtn"><button id="informBtn">예약 / 소장 정보</button></div> 
							</div>
						</div>
						<!-- 즐겨찾기 -->
						<div class="favorite">
